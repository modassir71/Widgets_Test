...
public class SOPullUpControl {
    ...
    // Variable enable touch
    public var canPulled: Bool = false
    ...
    public func updateStartCardHeight(_ height: CGFloat) {
        startCardHeight = height
        pullUpVC.view.frame = CGRect(x: 0, y: heightView - startCardHeight, width: widthView, height: endCardHeight)
    }
    
    public func enablePullUp() {
        pullUpVC.view.isUserInteractionEnabled = true
    }
