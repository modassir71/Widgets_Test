...
open class CoreDataStorage {
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
		...
		let modelURL = Bundle.main.url(forResource: "Widgets", withExtension: "momd")!
	...
	lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        let directory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: Constants.appGroupId)!
		let url = directory.appendingPathComponent("Widgets.sqlite")
		do {
