...
class UnsplashPhotoPickerViewController: UIViewController {
    ...
    public var imageSelectionDelegate: BackgroundsViewDelegate?
...
//    }()
    ...
    private lazy var searchBar: UISearchBar = {
        let searchBar = UISearchBar(frame: CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: 60))
        searchBar.delegate = self
        return searchBar
    }()
    
    private lazy var collectionView: UICollectionView = {
        let collectionView = UICollectionView(frame: CGRect(x: 0, y: 100, width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height - 100), collectionViewLayout: layout)
    ...
    private func setupSearchBarView() {
        ...
        NSLayoutConstraint.activate([
            ...
            collectionView.bottomAnchor.constraint(equalTo: collectionView.topAnchor),
