...
public class UnsplashPhotoPicker: UINavigationController {
    ...
    public init(configuration: UnsplashPhotoPickerConfiguration) {
        ...
        let unsplashPhotoPicker = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "UnsplashPhotoPickerViewController") as! UnsplashPhotoPickerViewController

        self.photoPickerViewController = unsplashPhotoPicker
